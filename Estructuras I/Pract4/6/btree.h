...
int btree_buscar(BTree arbol, void* dato);     //que retorne 1 si el n dado se encuentra en el ´arbol, y 0 en caso contrario.
...
int btree_sumar(BTree arbol, FuncionVisitante visit);                    //que retorne la suma total de los datos del arb.
